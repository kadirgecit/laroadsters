...
const SECTIONS = [
  ...
  { icon: Users, label: 'Member News', desc: 'Add, edit, or remove news posts', path: '/admin/member-news' },
  { icon: FolderArchive, label: 'Club Documents', desc: 'Upload bylaws, roster, and forms', path: '/admin/documents' },
  { icon: LayoutDashboard, label: 'Homepage', desc: 'Edit show info shown on the home page', path: '/admin/homepage' },
